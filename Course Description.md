...
This course is built around one semester-long project in which you will be the class subject expert for a particular topic. You will choose a subject of interest to you and (following Rheingold's model) collect, curate, filter, and write--building and contributing to a Personal Learning Network. You will also explore numerous technologies (RSS, Web Capturing/Archiving, Social Bookmarking, Digital Annotation, Web Workflows, and more) and search for ways to evaluate, manage, and make sense of a *large* amount of digital text. You won't do this alone, however, as much of our coursework is focused on collaboration. We will use class time to discuss, learn, create, curate, and write as a group.
...
* Build and participate in a Personal Learning Network
...
|  A | B |  C |  D |  F |
| -- | -- | -- | -- | -- |
| x | B+: 89-87% | C+: 79-77% | D+: 69-67% | x |
| A: 100-94% | B: 86-84% | C: 76-74% | D: 66-64% | F: 59=0% |
| A-: 93-90% | B-: 83-80% | C-: 73-70% | D-: 63-60% | x |
